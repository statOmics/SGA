---
title: "Advanced statistical analysis with msqrob2"
...
single TMT mixture^[Depending on the reagents used, 6, 10, 11 up to 18
samples can be pooled in one mixture]. The signal processing is also
...
The estimated log2 fold changes for HeLa proteins are closely distributed
around 0, as expected. log2 fold changes for UPS standard proteins are
distributed toward 1, but it has underestimated due to ion suppression
effects that are characteristic of data set with high spike-in
concentrations.
...
variables of interest, and you can explore the available covariation
