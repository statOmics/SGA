...
#### 2.3. Statistical Inference & Analysis of Experiments with Factorial Designs
  ...
  - Mixed Models:[html](./francisellaMixedModel.html)
  - Mixed Models for labelled proteomics: [html](./tmtMixedModel.html), [pdf](./tmtMixedModel.pdf)
<!---->
...
- Quasilikelihood: [html](./quasiLikelihood.html)
...
- [Differential Usage Background](./images_sequencing/DTU_jeroen.pdf)
- [Differential Usage](https://www.biorxiv.org/content/10.1101/2023.06.29.547014v3)
...
<!--
- Solution: [Macosko workflow](./singleCell_MacoskoWorkflow.html)
