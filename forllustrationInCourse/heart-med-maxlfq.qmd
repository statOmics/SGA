...
which centers each sample by subtracting its median log2 intensity so that all
samples are aligned to a common location.
...
2. Normalisation with Median method.
