...
$$
z^k = \eta^k + \left.\frac{\partial \eta}{\partial \mu}\right\vert_k (\mathbf{y} - \boldsymbol{\mu}^k) 
$$
...
qlRes
cbind(ql=qlRes[,2],pois=poisRes[,2],qlself=poisRes[,2]*sqrt(sigma2))
```
...
Anova(glm.qpois, test="F")[1,1]/Anova(glm.qpois, test="F")[1,2]/sigma2
```
